...
**提交作业时, 需要将 `src/ch4/main.c` 和其他实验的代码放在同一个文件夹中. 并把 `src/ch4/main.c` 命名为 "ch4_main.c".**

**同时需要将 `output/ch4/metrics.csv` 放在同一个文件夹内, 文件名为 `metrics.csv`.**

</LabNote>

<Callout title="扩展玩法：自定义 Config" type="idea">
